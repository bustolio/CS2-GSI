...
import com.cs2gsi.events.PlayerActivityChanged;
import com.cs2gsi.events.PlayerArmorChanged;
import com.cs2gsi.events.PlayerAssistsChanged;
import com.cs2gsi.events.PlayerBurningAmountChanged;
import com.cs2gsi.events.PlayerClanChanged;
import com.cs2gsi.events.PlayerDeathsChanged;
import com.cs2gsi.events.PlayerDefusekitChanged;
import com.cs2gsi.events.PlayerDied;
import com.cs2gsi.events.PlayerEquipmentValueChanged;
import com.cs2gsi.events.PlayerFlashAmountChanged;
import com.cs2gsi.events.PlayerForwardDirectionChanged;
import com.cs2gsi.events.PlayerGotKill;
import com.cs2gsi.events.PlayerHealthChanged;
import com.cs2gsi.events.PlayerHelmetChanged;
import com.cs2gsi.events.PlayerKillsChanged;
import com.cs2gsi.events.PlayerMVPsChanged;
import com.cs2gsi.events.PlayerMoneyAmountChanged;
import com.cs2gsi.events.PlayerNameChanged;
import com.cs2gsi.events.PlayerObserverSlotChanged;
import com.cs2gsi.events.PlayerPositionChanged;
import com.cs2gsi.events.PlayerRespawned;
import com.cs2gsi.events.PlayerRoundHeadshotKillsChanged;
import com.cs2gsi.events.PlayerRoundKillsChanged;
import com.cs2gsi.events.PlayerRoundTotalDamageChanged;
import com.cs2gsi.events.PlayerScoreChanged;
import com.cs2gsi.events.PlayerSmokedAmountChanged;
import com.cs2gsi.events.PlayerSpectationTargetChanged;
import com.cs2gsi.events.PlayerStateChanged;
import com.cs2gsi.events.PlayerStatsChanged;
import com.cs2gsi.events.PlayerSteamIDChanged;
import com.cs2gsi.events.PlayerTeamChanged;
...
import com.cs2gsi.events.PlayerWeaponChanged;
import com.cs2gsi.events.PlayerWeaponsDropped;
import com.cs2gsi.events.PlayerWeaponsPickedUp;
import com.cs2gsi.events.PlayerXPOverloadLevelChanged;
